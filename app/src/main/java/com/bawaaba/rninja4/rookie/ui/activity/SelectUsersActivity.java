...
import com.bawaaba.rninja4.rookie.ui.adapter.CheckboxUsersAdapter;
...
public class SelectUsersActivity extends BaseActivity {
    ...
    private void loadUsersFromQb() {
        ...
        QBUsers.getUsers(new QBPagedRequestBuilder(40, 1)).performAsync(new QBEntityCallback<ArrayList<QBUser>>() {
            @Override
