...
import com.bawaaba.rninja4.rookie.ui.activity.AttachmentImageActivity;
import com.bawaaba.rninja4.rookie.ui.widget.MaskedImageView;
import com.bawaaba.rninja4.rookie.utils.chat.ChatHelper;
import com.bawaaba.rninja4.rookie.utils.qb.Consts;
import com.bawaaba.rninja4.rookie.utils.qb.TimeUtils;
...
//
//            if (hasAttachments(chatMessage)) {
//                holder.messageAuthorTextView.setBackgroundResource(R.drawable.delete);
//                holder.messageAuthorTextView.setTextColor(ResourceUtils.getColor(R.color.text_color_white));
//            } else {
//                holder.messageAuthorTextView.setBackgroundResource(0);
//                holder.messageAuthorTextView.setTextColor(ResourceUtils.getColor(R.color.text_color_dark_grey));
