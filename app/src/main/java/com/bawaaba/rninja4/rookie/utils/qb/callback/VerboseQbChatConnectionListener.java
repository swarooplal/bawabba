...
//        snackbar = Snackbar.make(rootView, Appquick.getInstance().getString(R.string.connection_error), Snackbar.LENGTH_INDEFINITE);
//        snackbar.show();
    }
...
//            snackbar = Snackbar.make(rootView, Appquick.getInstance().getString(R.string.reconnect_alert, seconds), Snackbar.LENGTH_INDEFINITE);
//            snackbar.show();
        }
    }
