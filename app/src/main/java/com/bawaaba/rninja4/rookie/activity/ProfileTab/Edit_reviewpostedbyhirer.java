...
public class Edit_reviewpostedbyhirer extends BaseActivity {
    ...
    private AppCompatTextView posted_review;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_reviewpostedbyhirer);
    ...
    private void initViews() {
        ...
        posted_review=(AppCompatTextView)findViewById(R.id.posted_review);
...
//        Log.e("fhhhdh","tdtdtu");
//           review_posted.setVisibility(View.VISIBLE);
//       }else{
//           posted_review.setVisibility(View.VISIBLE);
//       }

        if (session.isLoggedIn() && db_id.equals(user_id)){
            review_posted.setVisibility(View.VISIBLE);
            posted_review.setVisibility(View.GONE);

        }else{
            posted_review.setVisibility(View.VISIBLE);
            review_posted.setVisibility(View.GONE);
        }
    }
                ...
                public void onClicked(final int position, View v) {
                    switch (v.getId()) {
                        ...
                        case R.id.ivEditFile:
                            final Dialog dialog = new Dialog(Edit_reviewpostedbyhirer.this);
                            ...
                            pic_file.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View view) {
                                    // pickImageSingle();
                                    int result = ContextCompat.checkSelfPermission(Edit_reviewpostedbyhirer.this, Manifest.permission.CAMERA);
                                    int result1 = ContextCompat.checkSelfPermission(Edit_reviewpostedbyhirer.this, Manifest.permission.READ_EXTERNAL_STORAGE);
                                ...
                                private void takePhoto() {
                                    ...
                                    try {
                                        AlertDialog.Builder builder = new AlertDialog.Builder(Edit_reviewpostedbyhirer.this);
                                ...
                                private void alert() {
                                    ActivityCompat.requestPermissions(Edit_reviewpostedbyhirer.this,
...
//            e.printStackTrace();
//        }
        final Dialog dialog = ObjectFactory.getInstance().getUtils(Edit_reviewpostedbyhirer.this).showLoadingDialog(Edit_reviewpostedbyhirer.this);
        dialog.show();
        Call<ResponseBody> responseBodyCall = ObjectFactory.getInstance().getRestClient(Edit_reviewpostedbyhirer.this).getApiService().deleteReview(
                "app-client",
                "123321",
        ...
        responseBodyCall.enqueue(new Callback<ResponseBody>() {
                        ...
                        if (responseString != null) {
                            ...
                            if (jsonObject != null) {
                                ...
                                if (!jsonObject.getBoolean("error")) {
                                    ...
                                    Toast.makeText(Edit_reviewpostedbyhirer.this, "Successfully Updated", Toast.LENGTH_SHORT).show();
                                    dialog1.dismiss();
                                    apiCallToUpdateProfileDatas();

                                } else {
                                    Toast.makeText(Edit_reviewpostedbyhirer.this, "Some error occurred", Toast.LENGTH_SHORT).show();
                                }
                            }
                        }
                    } catch (IOException e) {
            ...
            public void onFailure(Call<ResponseBody> call, Throwable t) {
                dialog.dismiss();
                Toast.makeText(Edit_reviewpostedbyhirer.this, "failed..", Toast.LENGTH_SHORT).show();
            }
        });
    }
                ...
                if (response.body() != null) {
                    try {
                        ...
                        if (responseString != null) {
                            ...
                            if (jsonObject != null) {
                                if (!jsonObject.getBoolean("error")) {
                                    Toast.makeText(Edit_reviewpostedbyhirer.this, "Successfully deleted", Toast.LENGTH_SHORT).show();
                                    apiCallToUpdateProfileDatas();
                                } else {
                                    Toast.makeText(Edit_reviewpostedbyhirer.this, "Some error occurred", Toast.LENGTH_SHORT).show();
                                }
    ...
    private void apiCallToUpdateProfileDatas() {
        Call<ResponseBody> responseBodyCall = ObjectFactory.getInstance().getRestClient(Edit_reviewpostedbyhirer.this).getApiService().getProfile(
                "app-client",
                "123321",
                ObjectFactory.getInstance().getAppPreference(getApplicationContext()).getUserId());
        responseBodyCall.enqueue(new Callback<ResponseBody>() {
